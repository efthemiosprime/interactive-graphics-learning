        ...
        <div className="mb-8 bg-gradient-to-r from-purple-100 to-indigo-100 rounded-lg shadow-lg p-6 border-2 border-purple-300">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-purple-700">Learn how to build an animation and interpolation editor from scratch using Vite and JavaScript</p>
            </div>
            <Link
              to="/animation-interpolation/tutorials"
