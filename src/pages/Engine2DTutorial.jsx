      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 bg-gradient-to-r from-purple-100 to-indigo-100 rounded-lg shadow-lg p-6 border-2 border-purple-300">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-bold text-purple-900 mb-2">📚 Complete Step-by-Step Tutorial</h2>
              <p className="text-purple-700">Learn how to build a 2D game engine from scratch using Vite and JavaScript</p>
            </div>
            <Link
              to="/engine2d-tutorial/complete"
