  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-100 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Tutorial Link */}
        <div className="mb-8 bg-gradient-to-r from-blue-100 to-cyan-100 rounded-lg shadow-lg p-6 border-2 border-blue-300">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-bold text-blue-900 mb-2">📚 Complete Tutorial</h2>
              <p className="text-blue-700">Learn how to build a transformation visualization editor from scratch using Vite and JavaScript</p>
            </div>
            <Link
              to="/transformation-visualization/tutorials"
