...
export default function Shaders() {
  ...
  const [activeTab, setActiveTab] = useState('output'); // 'output' or 'code'
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 p-8">
      <div className="max-w-7xl mx-auto">
          ...
          <div>
            ...
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <Link 
                  to="/shader/parallax-demo" 
                  className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-800 bg-blue-100 px-4 py-2 rounded-lg hover:bg-blue-200 transition-colors"
                >
                  🌊 Parallax Demo
                </Link>
              </div>
        ...
        {/* Tutorial Link */}
        <div className="bg-gradient-to-r from-purple-100 to-indigo-100 rounded-lg shadow-lg p-6 mb-8 border-2 border-purple-300">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-bold text-purple-900 mb-2">📚 Complete Tutorial</h2>
              <p className="text-purple-700">Learn how to create a shader visualization from scratch using Vite and JavaScript</p>
            </div>
            <Link
              to="/shaders/tutorial"
        ...
        {/* Main Content Grid - Shader Output and Controls Side by Side */}
        <div className="grid gap-8 grid-cols-1 lg:grid-cols-10 mb-8">
          {/* Shader Output/Code Tabs - 70% width (7 columns) */}
